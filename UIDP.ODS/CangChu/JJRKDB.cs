...
namespace UIDP.ODS.CangChu
{
    public class JJRKDB
    {
        ...
        {
            string sql = " SELECT a.*,b.NAME,c.ORG_SHORT_NAME,e.KCDD_NAME from JJRK a left join TS_DICTIONARY b on a.REASON=b.CODE" +
        ...
        {
            string sql = " UPDATE JJRK SET CODE=" + GetSQLStr(d["CODE"]);
